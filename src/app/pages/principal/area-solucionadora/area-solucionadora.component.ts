...
@Component({
  selector: 'app-area-solucionadora',
  templateUrl: './area-solucionadora.component.html',
  styleUrls: ['./area-solucionadora.component.css']
})
export class AreaSolucionadoraComponent implements OnInit {
