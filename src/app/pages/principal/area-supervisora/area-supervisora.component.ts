...
@Component({
  selector: 'app-area-supervisora',
  templateUrl: './area-supervisora.component.html',
  styleUrls: ['./area-supervisora.component.css']
})
export class AreaSupervisoraComponent implements OnInit {
